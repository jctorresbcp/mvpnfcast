          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Desafios e aprendizados</p>
              </div>
            </div>

            <p className="text-gray-300 leading-relaxed mb-6 max-w-md">
              Explorando os desafios únicos dos negócios familiares e transformando 
              conflitos em oportunidades de crescimento e aprendizado.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 mt-12">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              2025 Negócios Familiares Cast. Todos os direitos reservados.
            </div>
