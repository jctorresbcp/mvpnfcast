          ...
          <div>
            ...
            <div className="space-y-6 text-lg text-gray-700">
              <p className="leading-relaxed">
                O <strong>"Negócios Familiares Cast"</strong> é mais que um Podcast – é uma jornada pelos 
                desafios únicos que famílias enfrentam ao construir e manter empresas prósperas.
              </p>
              
              <p className="leading-relaxed">
                Nossa missão é explorar os dilemas da sucessão familiar, os conflitos entre afeto e negócio, 
                e as estratégias que transformam desafios em oportunidades de crescimento.
              </p>
              
              <p className="leading-relaxed">
                Aqui você encontra aprendizados práticos de quem viveu na pele os altos e baixos 
                de comandar uma empresa em família.
              </p>
            </div>
            
            <div className="mt-8 p-6 bg-gradient-to-r from-orange-50 to-purple-50 rounded-2xl border-l-4 border-orange-500">
              <p className="text-gray-600 italic text-lg">
                "Quando família e negócio se encontram, nascem histórias extraordinárias."
              </p>
            </div>
          </div>
