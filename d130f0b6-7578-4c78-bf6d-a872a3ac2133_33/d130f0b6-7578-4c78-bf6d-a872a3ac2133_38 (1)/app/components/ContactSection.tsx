          ...
          <div>
            ...
            <div className="mt-12 p-6 bg-gradient-to-r from-orange-50 to-purple-50 rounded-2xl">
              <h4 className="text-xl font-bold mb-4 text-gray-800">
                Sua família tem uma história para contar?
              </h4>
              <p className="text-gray-600 mb-4">
                Procuramos famílias empresárias com histórias inspiradoras de superação, 
                sucessão bem-sucedida ou desafios únicos de governança familiar.
              </p>
