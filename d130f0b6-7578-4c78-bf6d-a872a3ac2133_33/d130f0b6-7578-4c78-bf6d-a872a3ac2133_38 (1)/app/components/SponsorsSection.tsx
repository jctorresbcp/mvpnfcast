      ...
      <div className="container mx-auto px-6">
          ...
          <div>
            ...
            <div className="space-y-6 text-lg text-gray-700">
              <p className="leading-relaxed">
                <strong>Conecte sua marca ao universo dos negócios familiares.</strong> O Negócios Familiares Cast 
                é a ponte entre sua empresa e um público altamente qualificado: famílias empresárias, 
                sucessores e consultores especializados.
              </p>
              
              <p className="leading-relaxed">
                Nossos ouvintes são fundadores, herdeiros, gestores de empresas familiares e profissionais 
                que trabalham com governança familiar - um público com alto poder de decisão e investimento.
              </p>
            </div>
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-800">Empresas Familiares</h3>
                  <p className="text-gray-600">Audiência de famílias que controlam negócios</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-800">Alto Potencial de Negócios</h3>
                  <p className="text-gray-600">Decisores com necessidades específicas</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-800">Segmento Premium</h3>
                  <p className="text-gray-600">Nicho especializado em governança familiar</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-gray-50 to-purple-50 rounded-3xl p-8 text-center">
          <h3 className="text-2xl font-bold mb-4 text-gray-800">
            Empresas que já confiam no "Negócios Familiares Cast"
          </h3>
